...
/// Container containing all used colors in application, which are predefined
struct ColorConstants {
    ...
    static let darkMainBackground = UIColor(red: 45/255, green: 64/255, blue: 89/255, alpha: 0.6)
